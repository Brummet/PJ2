 ...
 *
 *   	public LispExprEvaluator()x
 *   	public LispExprEvaluator(String inputExpression)x 
 *      public void reset(String inputExpression)x 
...
public class LispExprEvaluator
{
    ...
    {
        inputExpr = inputExpression;
        while(!thisExprStack.isEmpty() && !thisOpStack.isEmpty()){
            thisExprStack.pop();
            thisOpStack.pop();
        }
    }
    ...
    private void evaluateCurrentOperation()
    {
        ...
        while(!thisExprStack.isEmpty()){
            // casts thisExprStack as double to push to thisOpStack
            temp = (Double) thisExprStack.pop();
     ...
     * It returns result of the expression 
     *
     * The algorithm:  
     *
    ...
    public double evaluate()
    {
        ...
        while (inputExprScanner.hasNext())
        {
            ...
            if (inputExprScanner.hasNextInt())
            {
                ...
                System.out.println(thisExprStack);
   		// more ...
            }
            else
            {
    ...
    private static void evaluateExprTest(String s, LispExprEvaluator expr, String expect)
    {
        ...
        System.out.println("Before reset: " + expr.thisExprStack);//my line of code
        expr.reset(s);
        System.out.println("After Reset: " + expr.thisExprStack);   // my line of code
